...
class Ui_dlgG28_30_1(object):
    def setupUi(self, dlgG28_30_1):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap(":/cn5X/images/questionG28.svg"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        self.buttonBox.setStandardButtons(
            QtWidgets.QDialogButtonBox.Cancel | QtWidgets.QDialogButtonBox.Yes
        )
    ...
    def retranslateUi(self, dlgG28_30_1):
        ...
        dlgG28_30_1.setWindowTitle(
            _translate("dlgG28_30_1", "Define G28.1 absolute position")
        )
        self.lblPosition.setText(
            _translate("dlgG28_30_1", "Current machine position (MPos)")
        )
        self.chkPosX.setToolTip(
            _translate(
                "dlgG28_30_1", "Uncheck to keep this axis at its current position"
            )
        )
        self.chkPosY.setToolTip(
            _translate(
                "dlgG28_30_1", "Uncheck to keep this axis at its current position"
            )
        )
        self.chkPosZ.setToolTip(
            _translate(
                "dlgG28_30_1", "Uncheck to keep this axis at its current position"
            )
        )
        self.chkPosA.setToolTip(
            _translate(
                "dlgG28_30_1", "Uncheck to keep this axis at its current position"
            )
        )
        self.chkPosB.setToolTip(
            _translate(
                "dlgG28_30_1", "Uncheck to keep this axis at its current position"
            )
        )
        self.chkPosC.setToolTip(
            _translate(
                "dlgG28_30_1", "Uncheck to keep this axis at its current position"
            )
        )
        self.lblMessage.setText(
            _translate(
                "dlgG28_30_1",
                "Save the current machine position (MPos) in the G28.1 Grbl's location?",
            )
        )
        self.chkDontShow.setText(
            _translate("dlgG28_30_1", "Don't show confirmation again")
        )
