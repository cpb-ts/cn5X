...
class grblConfig(QObject):
    ...
    def __init__(self, grbl: grblCom, nbAxis: int, axisNames: list):
        ...
        self.__buttonDiscard.setToolTip(
            self.tr("Close the dialog box without validating modifications.")
        )
        self.__buttonReset = self.__di.buttonBox.addButton(QDialogButtonBox.Reset)
        self.__buttonReset.setEnabled(False)
        self.__buttonReset.setToolTip(
            self.tr("Reloads all parameters from their current values in Grbl.")
        )
        self.__buttonFactory = self.__di.buttonBox.addButton(
            "Reset factory", QDialogButtonBox.ActionRole
        )
        self.__buttonFactory.setToolTip(
            self.tr(
        ...
        # QCheckBox
        self.__di.chkStepEnableInvert.stateChanged.connect(
            lambda: self.chkStateChange(self.__di.chkStepEnableInvert)
        )
        self.__di.chkLimitPinsInvert.stateChanged.connect(
            lambda: self.chkStateChange(self.__di.chkLimitPinsInvert)
        )
        self.__di.chkProbePinInvert.stateChanged.connect(
            lambda: self.chkStateChange(self.__di.chkProbePinInvert)
        )
        self.__di.chkReportInches.stateChanged.connect(
            lambda: self.chkStateChange(self.__di.chkReportInches)
        )
        self.__di.chkSoftLimits.stateChanged.connect(
            lambda: self.chkStateChange(self.__di.chkSoftLimits)
        )
        self.__di.chkHardLimits.stateChanged.connect(
            lambda: self.chkStateChange(self.__di.chkHardLimits)
        )
        self.__di.chkHomingCycle.stateChanged.connect(
            lambda: self.chkStateChange(self.__di.chkHomingCycle)
        )
        self.__di.chkLaserMode.stateChanged.connect(
            lambda: self.chkStateChange(self.__di.chkLaserMode)
        )
        # QSpinBox, QDoubleSpinBox
        self.__di.spinStepPulse.valueChanged.connect(
            lambda: self.spinChange(self.__di.spinStepPulse)
        )
        self.__di.spinStepIdleDelay.valueChanged.connect(
            lambda: self.spinChange(self.__di.spinStepIdleDelay)
        )
        self.__di.spinHomingDebounce.valueChanged.connect(
            lambda: self.spinChange(self.__di.spinHomingDebounce)
        )
        self.__di.spinMaxSpindle.valueChanged.connect(
            lambda: self.spinChange(self.__di.spinMaxSpindle)
        )
        self.__di.spinMinSpindle.valueChanged.connect(
            lambda: self.spinChange(self.__di.spinMinSpindle)
        )
        self.__di.dsbJunctionDeviation.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbJunctionDeviation)
        )
        self.__di.dsbArcTolerance.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbArcTolerance)
        )
        self.__di.dsbHomingFeed.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbHomingFeed)
        )
        self.__di.dsbHomingSeek.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbHomingSeek)
        )
        self.__di.dsbHomingPullOff.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbHomingPullOff)
        )
        self.__di.dsbStepsX.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbStepsX)
        )
        self.__di.dsbStepsY.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbStepsY)
        )
        self.__di.dsbStepsZ.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbStepsZ)
        )
        self.__di.dsbStepsA.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbStepsA)
        )
        self.__di.dsbStepsB.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbStepsB)
        )
        self.__di.dsbStepsC.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbStepsC)
        )
        self.__di.dsbTravelX.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbTravelX)
        )
        self.__di.dsbTravelY.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbTravelY)
        )
        self.__di.dsbTravelZ.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbTravelZ)
        )
        self.__di.dsbTravelA.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbTravelA)
        )
        self.__di.dsbTravelB.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbTravelB)
        )
        self.__di.dsbTravelC.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbTravelC)
        )
        self.__di.dsbMaxRateX.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbMaxRateX)
        )
        self.__di.dsbMaxRateY.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbMaxRateY)
        )
        self.__di.dsbMaxRateZ.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbMaxRateZ)
        )
        self.__di.dsbMaxRateA.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbMaxRateA)
        )
        self.__di.dsbMaxRateB.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbMaxRateB)
        )
        self.__di.dsbMaxRateC.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbMaxRateC)
        )
        self.__di.dsbAccelX.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbAccelX)
        )
        self.__di.dsbAccelY.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbAccelY)
        )
        self.__di.dsbAccelZ.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbAccelZ)
        )
        self.__di.dsbAccelA.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbAccelA)
        )
        self.__di.dsbAccelB.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbAccelB)
        )
        self.__di.dsbAccelC.valueChanged.connect(
            lambda: self.spinChange(self.__di.dsbAccelC)
        )
        # qwEditMask
        self.__di.emStepPortInvert.valueChanged.connect(
            lambda: self.editMaskChange(self.__di.emStepPortInvert)
        )
        self.__di.emDirectionPortInvert.valueChanged.connect(
            lambda: self.editMaskChange(self.__di.emDirectionPortInvert)
        )
        self.__di.emHomeDirInvert.valueChanged.connect(
            lambda: self.editMaskChange(self.__di.emHomeDirInvert)
        )
        # QLineEdit
        self.__di.lneEEPROM.textChanged.connect(
            lambda: self.textChange(self.__di.lneEEPROM)
        )
        ...
        self.__di.lneStatusReport.textChanged.connect(
            lambda: self.textChange(self.__di.lneStatusReport)
        )
    ...
    def showDialog(self):
        ...
        self.__dlgConfig.move(
            ParentX + int((ParentWidth - myWidth) / 2),
            ParentY + int((ParentHeight - myHeight) / 2),
        )
        self.__dlgConfig.setFixedSize(
            self.__dlgConfig.geometry().width(), self.__dlgConfig.geometry().height()
        )
        self.__dlgConfig.move(
            ParentX + int((ParentWidth - myWidth) / 2),
            ParentY + int((ParentHeight - myHeight) / 2),
    ...
    def __getGrblParams(self):
        self.__grblCom.realTimePush(
            REAL_TIME_SOFT_RESET, COM_FLAG_NO_OK
        )  # Envoi Ctrl+X.
    ...
    def on_sig_config(self, data: str):
        if data[:1] == "$":
            ...
            try:
                ...
                if (
                    len(decodeVer) == 3
                ):  # standard grbl(Mega-5X version is <major>.<minor>.<buildDate>
                ...
                self.sig_log.emit(
                    ...
                    self.tr(
                        "grblConfig.on_sig_config(): IndexError: list index out of range in Grbl's version string <{}>"
                    ).format(data),
                )
        elif data[:5] == "[AXS:":
            ...
            for o in list(decodeOpt[0]):
                try:
                    if grblCompilOptions[o][0]:
                        item = QStandardItem(
                            "{} : {}".format(o, grblCompilOptions[o][0])
                        )
                        model.appendRow(item)
                except KeyError:
                    item = QStandardItem(
                        "{} : {}".format(o, "Unknown Grbl compil option")
                    )
                    model.appendRow(item)
    ...
    def __setNbAxes(self, nb: int, names: str):
        ...
        self.__di.lblRateX.setText(
            self.tr("{} Max rate, mm/min ($110)").format(names[0])
        )
        self.__di.lblAccelX.setText(
            self.tr("{} Acceleration, mm/sec^2 ($120)").format(names[0])
        )
        self.__di.lblTravelX.setText(
            self.tr("{} Max travel, mm ($130)").format(names[0])
        )

        self.__di.lblStepsY.setText(self.tr("{} steps/mm ($101)").format(names[1]))
        self.__di.lblRateY.setText(
            self.tr("{} Max rate, mm/min ($111)").format(names[1])
        )
        self.__di.lblAccelY.setText(
            self.tr("{} Acceleration, mm/sec^2 ($121)").format(names[1])
        )
        self.__di.lblTravelY.setText(
            self.tr("{} Max travel, mm ($131)").format(names[1])
        )

        self.__di.lblStepsZ.setText(self.tr("{} steps/mm ($102)").format(names[2]))
        self.__di.lblRateZ.setText(
            self.tr("{} Max rate, mm/min ($112)").format(names[2])
        )
        self.__di.lblAccelZ.setText(
            self.tr("{} Acceleration, mm/sec^2 ($122)").format(names[2])
        )
        self.__di.lblTravelZ.setText(
            self.tr("{} Max travel, mm ($132)").format(names[2])
        )

        if nb > 3:
            self.__di.lblStepsA.setText(self.tr("{} steps/mm ($103)").format(names[3]))
            self.__di.lblRateA.setText(
                self.tr("{} Max rate, mm/min ($113)").format(names[3])
            )
            self.__di.lblAccelA.setText(
                self.tr("{} Acceleration, mm/sec^2 ($123)").format(names[3])
            )
            self.__di.lblTravelA.setText(
                self.tr("{} Max travel, mm ($133)").format(names[3])
            )
        else:
        ...
        if nb > 4:
            ...
            self.__di.lblRateB.setText(
                self.tr("{} Max rate, mm/min ($114)").format(names[4])
            )
            self.__di.lblAccelB.setText(
                self.tr("{} Acceleration, mm/sec^2 ($124)").format(names[4])
            )
            self.__di.lblTravelB.setText(
                self.tr("{} Max travel, mm ($134)").format(names[4])
            )
        else:
        ...
        if nb > 5:
            ...
            self.__di.lblRateC.setText(
                self.tr("{} Max rate, mm/min ($115)").format(names[5])
            )
            self.__di.lblAccelC.setText(
                self.tr("{} Acceleration, mm/sec^2 ($125)").format(names[5])
            )
            self.__di.lblTravelC.setText(
                self.tr("{} Max travel, mm ($135)").format(names[5])
            )
        else:
    ...
    def on_Apply(self):
        ...
        self.sig_config_changed.emit(
            self.tr("Save modified parameters : {}").format(self.__changedParams)
        )

        # Onglet 1 Initialisation
        if self.__di.lneEEPROM.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$I={}".format(str(self.__di.lneEEPROM.text()))
            )
        ...
        if self.__di.spinStepPulse.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$0={}".format(self.__di.spinStepPulse.value())
            )
        ...
        if self.__di.spinStepIdleDelay.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$1={}".format(self.__di.spinStepIdleDelay.value())
            )
        ...
        if self.__di.emStepPortInvert.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$2={}".format(self.__di.emStepPortInvert.getValue())
            )
            self.__grblCom.gcodePush(
                "$2={}".format(self.__di.emStepPortInvert.getValue())
            )
        if self.__di.emDirectionPortInvert.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$3={}".format(self.__di.emDirectionPortInvert.getValue())
            )
            self.__grblCom.gcodePush(
                "$3={}".format(self.__di.emDirectionPortInvert.getValue())
            )
        ...
        if self.__di.lneStatusReport in self.__changedParams:
            self.sig_config_changed.emit(
                "$10={}".format(self.__di.lneStatusReport.text())
            )
        ...
        if self.__di.dsbJunctionDeviation.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$11={}".format(self.__di.dsbJunctionDeviation.value())
            )
            self.__grblCom.gcodePush(
                "$11={}".format(self.__di.dsbJunctionDeviation.value())
            )
        if self.__di.dsbArcTolerance.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$12={}".format(self.__di.dsbArcTolerance.value())
            )
        ...
        if self.__di.emHomeDirInvert.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$23={}".format(self.__di.emHomeDirInvert.getValue())
            )
            self.__grblCom.gcodePush(
                "$23={}".format(self.__di.emHomeDirInvert.getValue())
            )
        if self.__di.dsbHomingFeed.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$24={}".format(self.__di.dsbHomingFeed.value())
            )
        ...
        if self.__di.dsbHomingSeek.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$25={}".format(self.__di.dsbHomingSeek.value())
            )
        ...
        if self.__di.spinHomingDebounce.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$26={}".format(self.__di.spinHomingDebounce.value())
            )
            self.__grblCom.gcodePush(
                "$26={}".format(self.__di.spinHomingDebounce.value())
            )
        if self.__di.dsbHomingPullOff.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$27={}".format(self.__di.dsbHomingPullOff.value())
            )
            self.__grblCom.gcodePush(
                "$27={}".format(self.__di.dsbHomingPullOff.value())
            )
        ...
        if self.__di.spinMaxSpindle.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$30={}".format(self.__di.spinMaxSpindle.value())
            )
        ...
        if self.__di.spinMinSpindle.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$31={}".format(self.__di.spinMinSpindle.value())
            )
        ...
        if self.__di.dsbMaxRateX.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$110={}".format(self.__di.dsbMaxRateX.value())
            )
        ...
        if self.__di.dsbMaxRateY.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$111={}".format(self.__di.dsbMaxRateY.value())
            )
        ...
        if self.__di.dsbMaxRateZ.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$112={}".format(self.__di.dsbMaxRateZ.value())
            )
        ...
        if self.__di.dsbMaxRateA.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$113={}".format(self.__di.dsbMaxRateA.value())
            )
        ...
        if self.__di.dsbMaxRateB.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$114={}".format(self.__di.dsbMaxRateB.value())
            )
        ...
        if self.__di.dsbMaxRateC.objectName() in self.__changedParams:
            self.sig_config_changed.emit(
                "$115={}".format(self.__di.dsbMaxRateC.value())
            )
    ...
    def on_ResetFactory(self):
        m = msgBox(
            ...
            info=self.tr(
                "All modifications and adjustments made to this instance of Grbl will be permanently lost!"
            ),
